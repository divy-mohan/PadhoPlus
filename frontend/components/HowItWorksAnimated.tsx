                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        >
                          ...
                          <div className={`mb-3 flex justify-center transition-all duration-500`}>
                            <div
              ...
              <ScrollAnimation key={idx} type="fade-up" delay={idx * 100}>
                <div className={`relative transition-all duration-500 ${
                  ...
                  >
                    ...
                    <div className={`w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-xl mb-4 shadow-lg transition-all duration-500 bg-gradient-to-br ${
